...
#ifndef __AIMATRIX43_H__
#define __AIMATRIX43_H__
...
public:
	...
	TMatrix43Temp<T> & FromQuaternion(const TQuat<T>& q)
	{
		T x2 = q.X + q.X;
		T y2 = q.Y + q.Y;
		T z2 = q.Z + q.Z;
	...
	TMatrix43Temp<T> & AddQuaternion(const TQuat<T>& q)
	{
		TMatrix43Temp<T> matrix;
	...
	TMatrix43Temp<T> & SetQuaternion(const TQuat<T>& q)
	{
		T x2 = q.X + q.X;
		T y2 = q.Y + q.Y;
		T z2 = q.Z + q.Z;
	...
	TMatrix43Temp<T> & SetTransform(const TVector3DTemp<T>& scale, const TQuat<T>& q, const TVector3DTemp<T>& translation)
	{
		T x2 = q.X + q.X;
		T y2 = q.Y + q.Y;
		T z2 = q.Z + q.Z;
	...
	TMatrix43Temp<T> & AddTransform(const TVector3DTemp<T>& scale, const TQuat<T>& q, const TVector3DTemp<T>& translation)
	{
		TMatrix43Temp<T> matrix;

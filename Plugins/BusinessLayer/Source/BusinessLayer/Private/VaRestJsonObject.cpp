...
bool UVaRestJsonObject::DecodeJson(const FString& JsonString)
{
	...
	UE_LOG(LogBusiness, Error, TEXT("Json decoding failed for: %s"), *JsonString);
...
float UVaRestJsonObject::GetNumberField(const FString& FieldName) const
{
	...
	{
		UE_LOG(LogBusiness, Warning, TEXT("No field with name %s of type Number"), *FieldName);
		return 0.0f;
	}
...
FString UVaRestJsonObject::GetStringField(const FString& FieldName) const
{
	...
	{
		UE_LOG(LogBusiness, Warning, TEXT("No field with name %s of type String"), *FieldName);
		return TEXT("");
	}
...
bool UVaRestJsonObject::GetBoolField(const FString& FieldName) const
{
	...
	{
		UE_LOG(LogBusiness, Warning, TEXT("No field with name %s of type Boolean"), *FieldName);
		return false;
	}
...
TArray<UVaRestJsonValue*> UVaRestJsonObject::GetArrayField(const FString& FieldName) const
{
	...
	{
		UE_LOG(LogBusiness, Warning, TEXT("No field with name %s of type Array"), *FieldName);
	}
...
UVaRestJsonObject* UVaRestJsonObject::GetObjectField(const FString& FieldName) const
{
	...
	{
		UE_LOG(LogBusiness, Warning, TEXT("No field with name %s of type Object"), *FieldName);
		return nullptr;
	}
...
TArray<float> UVaRestJsonObject::GetNumberArrayField(const FString& FieldName) const
{
	...
	for (TArray<TSharedPtr<FJsonValue> >::TConstIterator It(JsonArrayValues); It; ++It)
	{
		...
		{
			UE_LOG(LogBusiness, Error, TEXT("Not Number element in array with field name %s"), *FieldName);
		}
...
TArray<FString> UVaRestJsonObject::GetStringArrayField(const FString& FieldName) const
{
	...
	for (TArray<TSharedPtr<FJsonValue> >::TConstIterator It(JsonArrayValues); It; ++It)
	{
		...
		{
			UE_LOG(LogBusiness, Error, TEXT("Not String element in array with field name %s"), *FieldName);
		}
...
TArray<bool> UVaRestJsonObject::GetBoolArrayField(const FString& FieldName) const
{
	...
	for (TArray<TSharedPtr<FJsonValue> >::TConstIterator It(JsonArrayValues); It; ++It)
	{
		...
		{
			UE_LOG(LogBusiness, Error, TEXT("Not Boolean element in array with field name %s"), *FieldName);
		}
...
TArray<UVaRestJsonObject*> UVaRestJsonObject::GetObjectArrayField(const FString& FieldName) const
{
	...
	for (auto Value : ValArray)
	{
		...
		{
			UE_LOG(LogBusiness, Error, TEXT("Not Object element in array with field name %s"), *FieldName);
		}

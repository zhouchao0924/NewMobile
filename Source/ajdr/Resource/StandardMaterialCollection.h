...
public:
	...
	static UStandardMaterialCollection *GetMaterialCollection();
	UMaterialInterface  *GetMaterialByName(const FString &Name);
	static void SetMaterialCollection(UStandardMaterialCollection *Collection);
public:
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "StandardMaterial")
	TArray<FStdMaterialInfo>	  StdMaterials;
	static UStandardMaterialCollection *s_materialCollection;
};
